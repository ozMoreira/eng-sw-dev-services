...
public class OrderDbModel
{
    ...
    public List<OrderItemDbModel> Items { get; set; } = new();
    ...
    public static explicit operator Order?(OrderDbModel? orderDbModel)
    {
        ...
        return new Order
        {
            ...
            BillingAddress = JsonSerializer.Deserialize<Address>(orderDbModel.BillingAddress)!,
    ...
    public static explicit operator OrderDbModel?(Order? order)
    {
        ...
        return new OrderDbModel
        {
            ...
            Total = order.Total,
            Status = order.Status,
            BillingAddress = JsonSerializer.Serialize(order.BillingAddress),
